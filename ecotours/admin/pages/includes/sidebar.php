        ...
        <nav class="sidebar-nav">
          <ul>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="submenu">
                <li>
                  <a href="./home/hero.php"><i class="fas fa-image"></i> Hero</a>
                </li>
                <li>
                  <a href="./home/destinations.php"
                    ><i class="fas fa-map-marker-alt"></i> Destinations</a
                  >
                </li>
                <li>
                  <a href="./home/attractions.php"
                ...
                <li>
                    <a href="./home/month.php"
                    ><i class="fas fa-calendar-alt"></i> month</a
                  >
                </li>
                <li>
                  <a href="./home/partners.php"><i class="fas fa-handshake"></i> Partners</a>
                </li>
              </ul>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="./buildmessage.php"><i class="fas fa-map-marked-alt"></i> <span>Costom Trip</span></a>
            </li>
            <li class="nav-item">
