            ...
            <div class="contact-grid">
                ...
                <div class="contact-form-container">
                    ...
                    <?php else: ?>
                        ...
                        <form method="POST" class="contact-form" id="contactForm" onsubmit="const r = this.querySelector('[name=\'g-recaptcha-response\']'); if(r &amp;&amp; !r.value){ showRecaptchaModal('Please verify that you are human by checking the <strong>&quot;I\'m not a robot&quot;</strong> box before submitting your message.'); return false; }">
                            <div class="form-row">
