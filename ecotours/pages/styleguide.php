...
<body>
    ...
    <div class="hero-banner">
        <h1 class="hero-title">EAST AFRICA TRAVEL STYLES</h1>
        <p class="hero-subtitle">Curated expedition archetypes across Rwanda, Uganda, and the Virunga landscape</p>
    </div>
        ...
        <section class="intro-section">
            ...
            <div class="intro-columns">
                <div class="intro-column">
                    <p>Definitive East African safari experiences centered on expertly guided wildlife encounters, including gorilla trekking, primate tracking, and classic savannah exploration.</p>
                    <p>These journeys combine access, timing, and guiding into a seamless, high-impact safari structure.</p>
                </div>
                <div class="intro-column">
        ...
        <section class="stats-section">
            <div class="stats-grid">
                <div class="stat-item">
                    ...
                    <div class="stat-label">Signature Safari Journeys</div>
                </div>
                <div class="stat-item">
