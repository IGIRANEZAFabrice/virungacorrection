...
<div class="top-bar">
      ...
      <div class="top-nav" style="display: flex; align-items: center;">
        ...
        <div class="lang-dropdown notranslate" translate="no" style="position: relative; margin-left: 15px;">
          ...
          <ul class="lang-menu" id="langMenuEcoPages" style="position: absolute; top: 100%; right: 0; margin-top: 6px; background: #1f3123; border: 1px solid rgba(255,255,255,0.2); border-radius: 6px; list-style: none; padding: 6px 0; min-width: 150px; max-height: 280px; overflow-y: auto; display: none; z-index: 10010; box-shadow: 0 4px 15px rgba(0,0,0,0.3);">
    ...
    <div class="dropdown">
      <div class="dropdown-container">
        <div class="destination-group">
          <div class="nav-item-with-nested">
            <a href="./gorilla.php" class="has-sub">Wildlife Encounters</a>
          ...
          <div class="nav-item-with-nested">
            <a href="./museums.php" class="has-sub">Cultural Discovery</a>
            <div class="nested-dropdown">
              <div class="nested-dropdown-container">
                <a href="./museums.php">Museum</a>
                <a href="../index.php/ecotours/community">Community</a>
              </div>
            </div>
          </div>
          <div class="nav-item-with-nested">
            <a href="./cycling.php" class="has-sub">Adventure Collection</a>
            <div class="nested-dropdown">
              <div class="nested-dropdown-container">
      ...
      <div class="search-btn">
        <a href="../index.php/ecotours/community" target="_blank" rel="noopener noreferrer" style="display: flex; align-items: center; justify-content: center; gap: .5rem;"
          >
          Community Impact
        </a>
      </div>    
              ...
              <li class="mobile-nested-item">
                ...
                <div class="mobile-nested-dropdown">
                  <ul>
                    ...
                    <li><a href="../index.php/ecotours/community">Community</a></li>
                  </ul>
                </div>
              </li>
              <li class="mobile-nested-item">
    ...
    <div class="side-buttons">
      <div class="side-btn">
        <a href="https://wa.me/250784513435" target="_blank" rel="noopener noreferrer">
          <i class="fa-brands fa-whatsapp"></i>
        </a>
        <span>Whatsapp</span>
      </div>
...
<script type="text/javascript">
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const currentFlagEcoPages = document.getElementById("currentFlagEcoPages");
    ...
    if (currentFlagEcoPages) {
      currentFlagEcoPages.innerText = flagMap[currentLang] || '🇬🇧';
    }

    if (langBtnEcoPages && langMenuEcoPages) {
      langBtnEcoPages.addEventListener("click", (e) => {
        e.stopPropagation();
        langMenuEcoPages.style.display = (langMenuEcoPages.style.display === 'block') ? 'none' : 'block';
      });

      document.addEventListener("click", () => {
        langMenuEcoPages.style.display = 'none';
      });
    }
  });
</script>
