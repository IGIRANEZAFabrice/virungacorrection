...
$pages = [
    ...
    'cancellation-policy' => ['file' => __DIR__ . '/pages/cancellation-policy.php', 'cwd' => null, 'assetBase' => $link('')],
    'cancelation-policy' => ['file' => __DIR__ . '/pages/cancellation-policy.php', 'cwd' => null, 'assetBase' => $link('')],
